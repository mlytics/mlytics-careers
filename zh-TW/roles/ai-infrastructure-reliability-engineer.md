...
<a href="../../roles/ai-infrastructure-reliability-engineer.md">English</a>
</div>
...
**這不是傳統的 Platform 職位。** 我們不自建內部開發者平台、不設上線審批關卡。你的角色是**放大器**：建立可靠度機制、掌管 AI 成本、打造讓團隊敢動 legacy 的工程骨架。你定的機制會直接成為全公司的工程標準——而你做的成本優化，會直接出現在公司的損益表上。
